...
def load_graph(sequence_name):
    ...
    try:
        dismap = np.load( "/home/xli/NABProt/task2_NABPs/genT5attenmap/ATP/" + sequence_name + "_attmap.npy")
    except:
        dismap = np.load( "/home/xli/NABProt/task2_NABPs/genT5attenmap/ATP/" + sequence_name + "_attmap.npy")
    dismap=dismap[:-1,:-1]
...
def esmembedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/ATPfea/ATPesmfea/" + sequence_name + ".npy")
    #fea=fea[1:-1]
    return fea

def t5embedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/ATPfea/ATPt5fea/" + sequence_name + ".npy")
    fea=fea[:-1]
    return fea
...
trainset=pd.read_csv('/home/xli/NABProt/task2_NABPs/dataprocess/ATPdataprocess/ATPtrain388.csv')
testset=pd.read_csv('/home/xli/NABProt/task2_NABPs/dataprocess/ATPdataprocess/ATPtest41.csv')
