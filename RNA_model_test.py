...
def esmembedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/RNAfea/rna_esm_fea/" + sequence_name + ".npy")
    #fea=fea[1:-1]
    return fea

def t5embedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/RNAfea/rna_t5_fea/" + sequence_name + ".npy")
    fea=fea[:-1]
    return fea
...
def train_one_epoch(model, data_loader):
    ...
    for data in data_loader:
        ...
        y_pred = model(esm_features, t5_features,graph,w_embedding) 
...
testset=pd.read_csv('/home/xli/NABProt/task2_NABPs/dataprocess/RNArawdataprocess/RNAtest117.csv')
