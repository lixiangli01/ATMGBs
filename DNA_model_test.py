...
def esmembedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/DNAfea/dna_esm_fea/" + sequence_name + ".npy")
    #fea=fea[1:-1]
    return fea

def t5embedding(sequence_name):
    fea = np.load( "/home/xli/NABProt/task2_NABPs/genfea/DNAfea/dna_t5_fea/" + sequence_name + ".npy")
    fea=fea[:-1]
    return fea
...
#testset=pd.read_csv('/home/xli/NABProt/task2_NABPs/dataprocess/DNArawdataprocess/DNAtest46.csv')
...
#testset=pd.read_csv('/home/xli/NABProt/task2_NABPs/dataprocess/DNArawdataprocess/DNAtest181.csv')
